...
- Tasks stored as a brain page (`tasks/active.md`) with structured format
...
1. **Load current tasks.** `gbrain get tasks/active` — read the task list.
...
3. **Save.** `gbrain put tasks/active` — write updated task list.
