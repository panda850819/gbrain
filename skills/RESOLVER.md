...
| TW/US stock ticker mention ("NVTS 有什麼消息", "PLTR 補一下", "把這 5 檔的全名跟操盤人查一下", 4-digit TW ticker, 中文股票名) | `skills/stock-enrich/SKILL.md` |
...
| "ingest my transcripts", "distill my agent conversations", "capture my claude code / codex / hermes sessions", "what did I work on across my AI tools" | `skills/transcript-ingest/SKILL.md` |
