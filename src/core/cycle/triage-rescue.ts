...
import { maskAssistantAuthoredTranscript, normForGrounding } from './synthesize-verify.ts';
...
export function applyTriageRescue(
  ...
  const tNorm = normForGrounding(maskAssistantAuthoredTranscript(transcriptContent));
