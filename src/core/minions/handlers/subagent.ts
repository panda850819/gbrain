...
export function makeSubagentHandler(deps: SubagentDeps) {
  ...
  async function subagentHandlerInner(
    ...
    //
    // Defense in depth for direct or queue-bypassing native submissions.
    ...
    // External runtime forces the provider-neutral path; otherwise preserve
    // upstream truthiness and OpenRouter-Anthropic handling.
    const useGatewayLoop = runtimeConfigured
